module ApplicationHelper
 ...
 <textarea rows="3" name="permiso[espectro_attributes][frecuencia_espectro_attributes][0][zona_attributes][new_zona][nota]" id="permiso_espectro_attributes_frecuencia_espectro_attributes_0_zona_attributes_new_zona_Nota">
    ...
    '
    #resultado = resultado.gsub(/frecuencia_espectro_attributes\]\[0\]/,'frecuencia_espectro_attributes][new_frecuencia_espectro_attributes]').gsub(/frecuencia_espectro_attributes_0/,'frecuencia_espectro_attributes_new_frecuencia_espectro_attributes')
    #resultado
  end
...
<input class="form-control" step="0.00000000001" type="number" name="permiso[espectro_attributes][frecuencia_espectro_attributes][new_frecuencia_espectro_attributes][desde]" id="permiso_espectro_attributes_frecuencia_espectro_attributes_new_frecuencia_espectro_attributes_desde" />
</div>
<div class="form-group">
...
<input class="form-control" step="0.00000000001" type="number" name="permiso[espectro_attributes][frecuencia_espectro_attributes][new_frecuencia_espectro_attributes][hasta]" id="permiso_espectro_attributes_frecuencia_espectro_attributes_new_frecuencia_espectro_attributes_hasta" />
</div>
</div>
<div class="col-md-2">
<div class="form-group">
<label for="permiso_espectro_attributes_frecuencia_espectro_attributes_new_frecuencia_espectro_attributes_Tx Desde">Tx </label>
<input class="form-control" step="0.00000000001" type="number" name="permiso[espectro_attributes][frecuencia_espectro_attributes][new_frecuencia_espectro_attributes][tx_desde]" id="permiso_espectro_attributes_frecuencia_espectro_attributes_new_frecuencia_espectro_attributes_tx_desde" />
</div>
<div class="form-group">
<label for="permiso_espectro_attributes_frecuencia_espectro_attributes_new_frecuencia_espectro_attributes_Tx Hasta">Tx </label>
<input class="form-control" step="0.00000000001" type="number" name="permiso[espectro_attributes][frecuencia_espectro_attributes][new_frecuencia_espectro_attributes][tx_hasta]" id="permiso_espectro_attributes_frecuencia_espectro_attributes_new_frecuencia_espectro_attributes_tx_hasta" />
</div>
</div>
<div class="col-md-2">
<div class="form-group">
<label for="permiso_espectro_attributes_frecuencia_espectro_attributes_new_frecuencia_espectro_attributes_Rx Desde">Rx </label>
<input class="form-control" step="0.00000000001"  type="number" name="permiso[espectro_attributes][frecuencia_espectro_attributes][new_frecuencia_espectro_attributes][rx_desde]" id="permiso_espectro_attributes_frecuencia_espectro_attributes_new_frecuencia_espectro_attributes_rx_desde" />
</div>
<div class="form-group">
<label for="permiso_espectro_attributes_frecuencia_espectro_attributes_new_frecuencia_espectro_attributes_Rx Hasta">Rx </label>
<input class="form-control" step="0.00000000001"  type="number" name="permiso[espectro_attributes][frecuencia_espectro_attributes][new_frecuencia_espectro_attributes][rx_hasta]" id="permiso_espectro_attributes_frecuencia_espectro_attributes_new_frecuencia_espectro_attributes_rx_hasta" />
</div>
</div>
</div>
</div>
...
<option value="3">Transferencia de datos</option></select>
  ...
  <div class="col-md-3">
    <div class="form-group">
      ...
      <input class="form-control" step="0.00000000001" type="number" name="acuerdo_acceso_interconexion[servicios_interconexion_attributes][new_servicios_interconexion][precio_interconexion]" id="acuerdo_acceso_interconexion_servicios_interconexion_attributes_new_servicios_interconexion_precio_interconexion" />
    </div>
  </div>
...
<option value="3">Transferencia de datos</option></select>
  ...
  <div class="col-md-6">
    ...
    <input class="form-control" step="0.00000000001" type="number" name="oferta_interconexion[oferta_interconexion_servicios_attributes][new_oferta_interconexion_servicios][precio]" id="oferta_interconexion_oferta_interconexion_servicios_attributes_new_oferta_interconexion_servicios_precio" />
    </div>
    </div>
    </div>
    '
...
<option value="numeracion900">Servicios de llamadas de contenido numeración 900-10 dígitos</option>
...
<option value="aeronautica">Servicios de numeración aeronáutica</option>
<option value="sms_4digitos">Servicios Especiales de numeración corta cuatro dígitos Mensajería de Texto SMS</option>
<option value="especial905">Servicios especiales de llamadas masivas - numeración 905s</option>
<option value="especial900">Servicios especiales de Servicios de Información - numeración 900s</option></select>
</div>
<div class="form-group">
...
<option value="NO_VIGENTE">No Vigente</option></select>
  ...
  <div class="col-xs-6 col-md-4">
    <div class="form-group">
      ...
      <input class="form-control" step="0.00000000001" type="number" name="precios_tarifa[detalle_precios_tarifas_attributes][new_detalle_precios_tarifas][precio_tarifa]" id="precios_tarifa_detalle_precios_tarifas_attributes_new_detalle_precios_tarifas_precio_tarifa" />
    </div>
  </div>
</div>
</div>
